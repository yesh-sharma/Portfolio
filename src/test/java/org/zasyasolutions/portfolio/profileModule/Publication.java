...
public class Publication extends BaseTest{
	 ...
	 private LoginPage loginPage;
	  ...
	  private FormPage formPage;
	   ...
	   public String section = "Publications";
	   public String addButtonLabel = "Add Publications";
	    
	    @Test(description = "Adding Data to Publication Section in Profile Page",priority = 1,retryAnalyzer = RetryAnalyzer.class)
	    public void addAwaardPosition() throws InterruptedException {
	       ...
	       try {
	        ...
	        Thread.sleep(2000);
	        formPage.addPublicationData();
	        Thread.sleep(1000);
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
	        System.out.println("data added successfully");
	    }
	    
	    @Test(description = "Updating Data to Publication Section in Profile Page",priority=2,retryAnalyzer = RetryAnalyzer.class)
	    public void updatePublicationPosition() throws InterruptedException {
	        loginPage.performLogin();
	        profilePage.navigateToProfile();
	        ...
	        Thread.sleep(2000);
	        formPage.updatePublicationData();
	        Thread.sleep(1000);
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
	 	    System.out.println("data updated successfully");
	    }
	    
	    @Test(description = "Deleting Data from Publication Section in Profile Page",priority=3,retryAnalyzer = RetryAnalyzer.class)
	    public void deletePublicationPosition() throws InterruptedException {
	        loginPage.performLogin();
	        profilePage.navigateToProfile();
