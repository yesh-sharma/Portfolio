...
public class Summary extends BaseTest {
	...
	@Test(description = "Adding Data to Summary Section in Profile Page", priority = 1, retryAnalyzer = RetryAnalyzer.class)

	public void addSummaryPosition() throws InterruptedException {
		...
		String summaryData = "Updateed -----   ----- Experienced software developer with background in Java and Selenium automation. Skilled in implementing robust test frameworks";

		formPage.addSummaryData(summaryData);
		Thread.sleep(1000);
		Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
		System.out.println("data added successfully");
	}

	@Test(description = "Validating empty Section in Profile Page", priority = 2, retryAnalyzer = RetryAnalyzer.class)

		public void emptySummaryPosition() throws InterruptedException {
		loginPage.performLogin();
		profilePage.navigateToProfile();
