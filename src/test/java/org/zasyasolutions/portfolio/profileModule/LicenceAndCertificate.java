...
public class LicenceAndCertificate extends BaseTest {
	  ...
	  private FormPage formPage;
	   ...
	   public String section = "Licenses & Certifications";
	   public String addButtonLabel = "Add Certificate";
	    
	    @Test(description = "Adding Data to Certificate Section in Profile Page",priority = 1, retryAnalyzer = RetryAnalyzer.class)
	    public void addCertificatePosition() throws InterruptedException {
	       ...
	       try {
	        ...
	        Thread.sleep(2000);
	        formPage.addCertificateData();
	        Thread.sleep(1000);
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
	        System.out.println("data added successfully");
	    }
	    
	    @Test(description = "Adding Data to Certificate Section in Profile Page",priority=2, retryAnalyzer = RetryAnalyzer.class)
	    public void updateCrtificatePosition() throws InterruptedException {
	        loginPage.performLogin();
	        profilePage.navigateToProfile();
	        ...
	        Thread.sleep(2000);
	        formPage.updateCertificateData();
	        Thread.sleep(1000);
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
	 	    System.out.println("data updated successfully");
	    }
	    
	    @Test(description = "Adding Data from Certificate Section in Profile Page",priority=3, retryAnalyzer = RetryAnalyzer.class)
	    public void deleteCertificatePosition() throws InterruptedException {
	        loginPage.performLogin();
	        profilePage.navigateToProfile();
