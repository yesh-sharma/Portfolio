...
public class JobPosition extends BaseTest {
	  ...
	  private FormPage formPage;
	    ...
	    public String section = "Job Position";
		   public String addButtonLabel = "Add Experience";
	    
	    
	    @Test(description = "Adding Data to Job Position Section in Profile Page",priority = 1, retryAnalyzer = RetryAnalyzer.class)
	    public void addJobPosition() throws InterruptedException {
	    ...
	    @Test(description = "Adding Data to Job Position Section in Profile Page",priority=2,retryAnalyzer = RetryAnalyzer.class)
	    public void updateJobPosition() throws InterruptedException {
	        loginPage.performLogin();
	        profilePage.navigateToProfile();
	        ...
	        Thread.sleep(2000);
	        formPage.updateJobData();
	        Thread.sleep(1000);
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
	 	    System.out.println("Job Position updated successfully");
	    }
	    
	    @Test(description = "Adding Data to Job Position Section in Profile Page",priority=3, retryAnalyzer = RetryAnalyzer.class)
	    public void deleteJobPosition() throws InterruptedException {
	        loginPage.performLogin();
	        profilePage.navigateToProfile();
	        ...
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Record Deleted Successfully");
	 	    System.out.println("Job Position deleted successfully");
	    }
