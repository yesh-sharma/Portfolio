...
public class AwardAndHonors extends BaseTest {
	  ...
	  private FormPage formPage;
	   ...
	   public String section = "Awards & Honors";
	   public String addButtonLabel = "Add Awards";
	    
	    @Test(description = "Adding Data to Award Section in Profile Page",priority = 1,retryAnalyzer = RetryAnalyzer.class)
	    public void addAwaardPosition() throws InterruptedException {
	       ...
	       try {
	        ...
	        Thread.sleep(2000);
	        formPage.addAwardData();
	        Thread.sleep(1000);
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
	        System.out.println("data added successfully");
	    }
	    
	    @Test(description = "Update Data to Award Section in Profile Page",priority=2,retryAnalyzer = RetryAnalyzer.class)
	    public void updateAwardPosition() throws InterruptedException {
	        ...
	        Thread.sleep(2000);
	        formPage.updateAwardData();
	        Thread.sleep(1000);
	        Assert.assertEquals(crudPage.successNotificationMessage(), "Profile updated successfully");
	 	    System.out.println("data updated successfully");
	    }
	    
	    @Test(description = "Deleting Data from Job Position Section in Profile Page",priority=3,retryAnalyzer = RetryAnalyzer.class)
